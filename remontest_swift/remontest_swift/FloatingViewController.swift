...
class FloatingViewController: UIViewController, RemonDelegate {
    ...
    */
    ...
    func initRemon() {
        ...
        cID 및 각종 파라메터 추가
        */
        core = remon(view: self.view, delegate: self)       //광고 sdk 초기화 및 광고 뷰 설정
        core.clientID = "MTQyOTE5Mjg5OTcyOTEz"              //발급 받은 cId로 대치 (Mandatory)
        ...
        core.isFloating = true                              //Floating 여부 설정(플로팅으로 사용시 필수)
        core.offset = CGPointMake(50.0, 100.0)              //광고 노출 offset
