...
class InlineViewController: UIViewController, RemonDelegate {
    ...
    override func viewDidLoad() {
        ...
        adView = UIView(frame: CGRectMake(0.0, screenBounds.size.height - 50.0, screenBounds.size.width, 50.0))
    ...
    */
    ...
    func initRemon() {
        ...
        */
        ...
        core.clientID = "MTQyOTE5MjkxNzcyOTEw"              //발급 받은 cId로 대치 (Mandatory)
