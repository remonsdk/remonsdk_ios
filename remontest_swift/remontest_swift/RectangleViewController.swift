...
class RectangleViewController: UIViewController, RemonDelegate {
    ...
    override func viewDidLoad() {
        ...
        adView = UIView(frame: CGRectMake(0.0, screenBounds.size.height - 250.0, screenBounds.size.width, 250.0))
    ...
    */
    ...
    func initRemon() {
        ...
        */
        ...
        core.clientID = "MTQyOTE5MjkxMTcyOTEx"              //발급 받은 cId로 대치 (Mandatory)
